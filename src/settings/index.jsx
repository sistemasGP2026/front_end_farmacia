const sidebar1 = require('assets/images/sidebar8.jpg');
//  you can import sidebar1, sidebar2, .... up to sidebar8 

const themeConfig = {
  sidebar: 'gredient8', // You can put light, dark, gredient1, gredient2, gredient3.....up to...gredient8 as per your need
  topbar: 'gredient8', // You can put light, dark, gredient1, gredient2, gredient3.....up to...gredient8 as per your need
