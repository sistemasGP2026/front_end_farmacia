...
class InformePrescripciones extends React.Component {
    ...
    Filtrar = () => {
        ...
        fetch(gsUrlApi + '/prescripcioneslogs/Informe', {
            method: 'POST',
            body: JSON.stringify({ FechaInicio: this.state.fechaDay, FechaFin: this.state.fechaDay2, Sede: this.state.Sede ?this.state.Sede.value: null, UnidadFuncional: this.state.UnidadFuncional? this.state.UnidadFuncional.value : null }),
            headers: {
                'Content-Type': 'application/json; charset=UTF-8',
                'Accept': 'application/json',
            }
                                        ...
                                        {this.state.ArrayDispensaciones.map((e, i) => {
                                            return (
                                                <tr key={i} className="border-bottom">
                                                    ...
                                                    <td>{e.IdentificacionPaciente}{" - "}{e.NombreCompleto}</td>
