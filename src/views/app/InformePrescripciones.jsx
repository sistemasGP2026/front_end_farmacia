...
class InformePrescripciones extends React.Component {
    ...
    Filtrar = () => {
        ...
        fetch(gsUrlApi + '/prescripciones/Informe', {
            method: 'POST',
            body: JSON.stringify({ 
                FechaInicio: this.state.fechaDay, FechaFin: this.state.fechaDay2, 
                Sede: this.state.Sede ?this.state.Sede.value: null, 
                UnidadFuncional: this.state.UnidadFuncional? this.state.UnidadFuncional.value : null,
                EstadoArchivadas: this.state.EstadoArchivadas? this.state.EstadoArchivadas: null
            }),
            headers: {
                'Content-Type': 'application/json; charset=UTF-8',
                'Accept': 'application/json',
    ...
    Archivadas = (event) => {
        if (event.target) { 
            if (event.target.checked === true) {
                this.setState(state => ({
                    ...state, EstadoArchivadas: true
                }))
            }else{
                this.setState(state => ({
                    ...state, EstadoArchivadas: false
                }))
            }
        }
    }
    ...
    render() {
        return (
            <>
                ...
                <div className="row">
                    <input type="checkbox" checked={this.state.EstadoArchivadas} className="cursor-pointer ml-5 mr-1" onChange={this.Archivadas} />
                                        ...
                                        {this.state.ArrayDispensaciones.map((e, i) => {
                                            return (
                                                <tr key={i} className="border-bottom">
                                                    ...
                                                    <td>{e.TipoDocumento + " - "}{e.IdentificacionPaciente}{" - "}{e.NombrePaciente}</td>
