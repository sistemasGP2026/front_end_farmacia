...
import ContactListComponent from "components/SolicitudesPendientes/TableDispensaciones";
import ContactWrapper from "components/SolicitudesPendientes/Dispensaciones.style";
import { contactList } from "util/data/contacts";
import { remove, findIndex, filter } from "lodash";
import DispensacionesForm from "components/SolicitudesPendientes/DispensacionesForm";
...
class CargarUsuarios extends React.Component {
  ...
  consultarsolicitudes() {
    ...
    let Sede = ObjSesion.Usuario.Sede.label;
    this.state.SedeDestino = ObjSesion.Usuario.Sede.label
    fetch(gsUrlApi + '/solicitudes_requisiciones/listarporestado/'+Sede+'/Pendiente', {
      method: 'GET',
      body: JSON.stringify(),
      headers: {
