...
class Userlists extends React.Component {
    ...
    Filtrar = () => {
        ...
        fetch(gsUrlApi + '/dispensaciones/InformeAprovechamiento', {
            method: 'POST',
            ...
            <>
                ...
                <div className="right-panel roe-box-shadow">
                    <div className="contact-list-header row">
                        <div className="ml-4">
                            <h4> Informe Dispensaciones Aprovechamientos</h4>
                        </div>
                        <>
                                        ...
                                        {this.state.ArrayDispensaciones.map((e, i) => {
                                            return (
                                                <tr key={i} className="border-bottom">
                                                    ...
                                                    <td>{e.Productos.length > 0 && e.Productos.length < 2
                                                        ? e.Productos[0].CodigoEntrega
                                                        : ""}</td>
                                                    ...
                                                    <td>{e.Plan}</td>
                                                    <td>{e.Productos.length > 0 && e.Productos.length < 2
                                                        ? e.Productos[0].Codigo
                                                        : ""}</td>
                                                    <td>{e.Productos.length > 0 && e.Productos.length < 2
                                                        ? e.Productos[0].Nombre
                                                        : ""}</td>
