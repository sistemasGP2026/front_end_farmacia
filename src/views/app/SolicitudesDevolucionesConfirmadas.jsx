...
import TableGroup from "components/devolucionesAprovechamientoConfirmadas/tableGroup";
import Filtros from "components/filtros/Filtros";
import RecepcionesForm from "components/devolucionesAprovechamientoConfirmadas/HistorialDevolucionesForm";
...
class CargarUsuarios extends React.Component {
  ...
  async componentDidMount() {
    ...
    fetch(gsUrlApi + '/devolucionesAprovechamientoConfirmadas/listarHistorial', {
      method: 'POST',
