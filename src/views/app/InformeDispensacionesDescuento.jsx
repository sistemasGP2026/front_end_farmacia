...
class Userlists extends React.Component {
    ...
    Filtrar = () => {
        ...
        fetch(gsUrlApi + '/dispensaciones/informeDescuentos', {
            method: 'POST',
            ...
            <>
                ...
                <div className="right-panel roe-box-shadow">
                    <div className="contact-list-header row">
                        <div className="ml-4">
                            <h4> Informe Dispensaciones - Devoluciones</h4>
                        </div>
                        <>
                                ...
                                <Table striped bordered hover className="mb-0" id={["Identificacion"]}>
                                    <thead className="">
                                        <tr className="border-bottom">
                                            ...
                                            <th>Cantidad Devuelta Aprovecha..</th>
                                        ...
                                        {this.state.ArrayDispensaciones.map((e, i) => {
                                            return (
                                                <tr key={i} className="border-bottom">
                                                    ...
                                                    <td>{e.CantidadDevolver }</td>
                                                    <td>{e.CantidadDevolverA }</td>
                                                    <td>{e.CantidadRestante}</td>
