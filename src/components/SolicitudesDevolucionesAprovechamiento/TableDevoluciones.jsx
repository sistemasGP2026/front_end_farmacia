...
class TablaModelo extends React.Component {
  ...
  deleteSelected = async (Item) => {
    ...
    fetch(gsUrlApi + "/solicitudes_devoluciones/eliminar/", {
      ...
      .then((data) => {
        ...
        this.props.actiononButton("guardar")
      })
  ...
  AbrirCabeceraPrincipal = data => {
    if (this.props.arrayDevoluciones[data].EstadoOpen == true) {
      this.props.arrayDevoluciones[data].EstadoOpen = false;
      this.setState((state) => ({
        ...state, arrayDevoluciones: this.props.arrayDevoluciones
      }));
    } else {
      this.props.arrayDevoluciones[data].EstadoOpen = true;
      this.setState((state) => ({
        ...state, arrayDevoluciones: this.props.arrayDevoluciones
      }));
    };
      ...
      <TableContainer component={Paper}>
        <div style={{ padding: '10px' }}>
          <div className="row  col-sm-12 col-md-12">
            <div className="form-group col-md-5">
              <h5>
                <i className="fas fa-notes-medical" /> Solicitud Devoluciones
              </h5>
            </div>
            <>
        ...
        <Table aria-label="collapsible table">
          ...
          <TableBody>
            ...
            {this.props.arrayDevoluciones.map((row, i) => (
              <>
                  ...
                  <TableCell component="th" scope="row">
                    <div className="row">
                      <div className="font-weight-bold">
                        <i style={{ color: "#3b83bd" }} className="fas fa-circle mt-1 mr-2"></i>{row.NombrePaciente}
                      </div>{"    - "} {row.TipoDocumento} - {row.IdentificacionPaciente}
                    </div>
                    <div className="row">
                      {row.Sede} - <i style={{ color: "#d64baa" }} className="fas fa-pills mt-1 ml-3 mr-1">:</i> {row.ArrayMedicamentos.length}
                    </div>
                  </TableCell>
                  <TableCell component="th" scope="row">
                    <div className="row">
                        ...
                        <Table size="small" aria-label="purchases">
                          <TableHead>
                            <TableRow>
                              ...
                              <TableCell align="right">Equivalencia</TableCell>
                          ...
                          <TableBody>
                            ...
                            {this.props.arrayDevoluciones[i]["ArrayMedicamentos"].map((historyRow) => (
        ...
        <TablePagination
          ...
          component="div"
          count={this.state.arrayDevoluciones.length}
