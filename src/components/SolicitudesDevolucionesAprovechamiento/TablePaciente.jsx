    ...
    <div className="right-panel roe-box-shadow">
      <div className="contact-list-header">
        ...
        <Button  
          ...
          className="c-btn ml-2 c-secundari">
          Nuevo
        </Button>
        </div>
        {isSearch && (
          ...
          <div className="mx-auto">
            <div className="row ">
              <div className="font-weight-bold" >
                <h5 style={{color: "black"}} htmlFor="">SOLICITUDES DE REQUISICIÓN</h5>
              </div>
            </div>
                ...
                {Userlists.map((e, i) => {
                  return (
                    <tr key={i}>
                      <td>
                        <div className="flex center">
                        <div className="ml-10">{e.TipoIdentificacion}-{e.Identificacion}</div>
                        </div>
                      </td>
                      <td>
                        <div className="">
                        ...
                        {/* {e.NombreCompleto +'-'+e.NombreCompleto } */}
                      </td>
                      <td>{e.Email}</td>
                      {/* <td>
                        <i
