                  ...
                  {ListaSolicitudes.map((e, i) => {
                    return (
                      <tr key={i}>
                          ...
                          <div className="ml-10">
                            <div className="row">
                              <div className="">
                                <i
                                  style={{ color: "#3b83bd" }}
                                  className="fas fa-circle mt-1 mr-1"
                                ></i>
                                {"Usuario: " + e.Usuario} -{" "}
                                {"  Sede Destino:  " + e.SedeDestino} <br></br>
                                &nbsp; - {"Unidades:  " + e.Unidades}
                              </div>
                              {/* <div className="">
                        ...
                        <td>
                          Fecha: {e.Fecha ? e.Fecha.substring(0, 10) : ""}
                          <br></br>
                          Hora:  {e.txtHora ? e.txtHora.substring(0, 5) : ""}
                        </td>
