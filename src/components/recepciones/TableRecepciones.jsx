        ...
        >
          {listPacientes && listPacientes.length ? (
            <Table  hover className="mb-0">
                    ...
                    <tr key={i} >
                      ...
                      <td>
                        <div className="ml-10">
                          ...
                          <div className="row">
                          {e.UnidadFuncional} <i style={{color: "green"}} className="fas fa-procedures mt-1 ml-2 mr-1">:</i>{e.NombreCama} {e.LogoMedico}{e.NombreUsuario}<i style={{color: "#d64baa"}} class="fas fa-pills mt-1 ml-3 mr-1">:</i> {e.TotalProductos}
                          </div>
                        </div>
                      </td>
                      {/* <td>
              ...
              {/* <Button>Recibir medicamentos seleccionados</Button> */}
            </Table>
