    ...
    <Fragment>
      ...
      <div className="right-panel roe-box-shadow">
            ...
            <div className="mx-auto">
              <div className="row ">
                <div className="font-weight-bold" >
                  <h5 style={{ color: "black" }} htmlFor="">SOLICITUDES DISPENSADAS</h5>
                </div>
              </div>
        ...
        <div className="contact-table">
          ...
          >
            {ListaSolicitudes && ListaSolicitudes.length ? (
              <Table hover className="mb-0">
                <tbody className="border">
                  {ListaSolicitudes.map((e, i) => {
                    return (
                      <tr key={i} >
                        <td>
                          <div className="flex center">
                        ...
                        <td>
                          <div className="ml-10">
                            <div className="row">
                              <div className="row">
                                <i style={{ color: "#3b83bd" }} className="fas fa-circle mt-1 mr-1"></i>{e.Usuario} - {"  Sede:  " + e.SedeDestino}
                              </div>
                              <div className="">
                                 {" Unidades:  " + e.Unidades}<i style={{ color: "#d64baa" }} className="fas fa-pills mt-1 ml-3 mr-1">:</i> {e.CantidadMedicamentos}
                              </div>
                            </div>
                          </div>
                        </td>
                        ...
                        <td style={{minWidth: "117px"}}>
                          {e.FechaRegistroDispensacion ? e.FechaRegistroDispensacion.substring(0, 10) : ""}
                          <br></br>
                          Hora:  {e.txtHoraRegistroDispensacion ? e.txtHoraRegistroDispensacion : ""}
                        </td>
                        {/* <td>{e.FechaRegistroDispensacion ? e.FechaRegistroDispensacion.substring(0, 10)
                          : ""}</td>
                           <td>{e.FechaRegistroDispensacion ? e.FechaRegistroDispensacion.substring(11, 16)
                          : ""}</td> */}
                        <td className="text-success font-weight-bold">{e.Estado ? e.Estado : ""}</td>
                        <td>
                          <i
                            className="fas fa-eye more-vert-icon cursor-pointer"
                            style={{ fontSize: 20 }}
