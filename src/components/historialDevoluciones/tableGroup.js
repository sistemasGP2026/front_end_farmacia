...
import PrintData from '../devoluciones/PrintData';
              ...
              <div className="form-group col-md-9" >
                <div className="searchStyle pos-relative mr-3">
                  ...
                  <Input
                    ...
                    placeholder="Buscar "
                    className="react-form-search-input form-control"
              ...
              <>
                <TableRow>
                  ...
                  <div className="row">{row.NombreCentroAtencion}</div>
                    ...
                    <div className="row ">Recibido por:<div className="ml-2 font-weight-bold">{row.UsuarioFarmacia}</div></div>
                  </TableCell>
                  <TableCell> 
                     <div className="row">
                    ...
                    <Collapse in={row.EstadoOpen} timeout="auto" unmountOnExit>
                      <Box margin={1}>
                        ...
                        <Table size="small" aria-label="purchases">
                          ...
                          {this.props.Userlists[i]["ArrayMedicamentos"].map((RowProducto) => (
                            <> 
                            <TableBody>
                              <TableRow>
                                <TableCell>
                                ...
                                <TableCell>
                                  {RowProducto.Generico}
                                </TableCell>
                                <TableCell>
                                  {RowProducto.Lote}
                                </TableCell>
                                <TableCell className="text-right">
                                  {RowProducto.CantidadDevolver}
                                </TableCell>
                                <TableCell className="text-center"> 
                                    <button type="button" className="text-12 text-white" disabled style={{ background: "limegreen", border: "0px", padding: "5px", borderRadius: "15px" }}>Devuelto</button>
                                </TableCell>
                              </TableRow>
                            </TableBody>
                            </>
