...
class RequisicionesForm extends React.Component {
    ...
    async componentDidMount() {
        ...
        fetch(gsUrlApi + '/solicitudes_requisiciones/listar/5cac12055d717e661ea7b95b', {
            ...
            .then((data) => {
                ...
                this.listarBodegaPorSede(this.props.data.Unidades, ObjSesion?.Usuario?.Sede?.value)
                this.setState(state => ({
    ...
    listarBodegaPorSede = (UnidadFuncional, CodigoSede) => {
        fetch(gsUrlApi + '/homologacionBodegasPorSedes/listar', {
            method: 'POST',
            body: JSON.stringify({UnidadFuncional: UnidadFuncional, CodigoSede: CodigoSede}),
            headers: {
                'Content-Type': 'application/json; charset=UTF-8',
                'Accept': 'application/json',
            }
                    ...
                    <div style={{ padding: "15px" }}>
                        ...
                        <div className="row mt-2">
                            <div className="col-md-6 pl-3 row">
                                ...
                                <div className=" ml-2">
                                    {this.state.ListaPedido.txtFecha}
                                </div>
                            </div>
                            <div className="col-md-6 row">
                                <div className="font-weight-bold">
                                            ...
                                            return (
                                                <tr key={i} style={{ backgroundColor: e.ColorBorder }}>
                                                    <td style={{ width: "119px" }}>
                                                        <div className="">{this.state.ListaPedido.Fecha.substring(0, 10)} Hora: {this.state.ListaPedido.Fecha.substring(11, 16)}</div>
                                                    </td>
                                                    ...
                                                    <td style={{ width: "100px" }}><input className="form-control" id={i} value={e.ArrayMedicamentos ? e.ArrayMedicamentos.Entrega : e.Entrega} disabled onChange={this.handleChange} type="number" /></td>
