                  ...
                  <TableCell component="th" scope="row">
                    <div className="row">
                      <div className="font-weight-bold">
                        <i style={{ color: "#3b83bd" }} className="fas fa-circle mt-1 mr-2"></i>{row.Usuario}
                      </div>- <i style={{ color: "#d64baa" }} className="fas fa-pills mt-1 ml-3 mr-1">:</i> {row.ArrayMedicamentos.length}
                      {/* {" - Edad:"}{row.Edad}{"    - "} {row.TipoDocumento} - {row.IdentificacionPaciente} */}
                    </div>
                    <div className="row">
                      {row.UnidadFuncional}
                       {/* -<i style={{ color: "#d64baa" }} className="fas fa-pills mt-1 ml-3 mr-1">:</i> {row.ArrayMedicamentos.length} */}
                      {/* <i className=" ml-3 mr-1"> Caso: {row.Caso}</i> */}
                    </div>
                  </TableCell>
                  <TableCell>
                    <div className="row">
                    {row.FechaRegistroSolicitudRequisicion ? row.FechaRegistroSolicitudRequisicion.substring(0, 10): ""}
                    </div>
                    <div className="row">
                      Hora: {row.FechaRegistroSolicitudRequisicion ? row.FechaRegistroSolicitudRequisicion.substring(11, 16): ""}
                    </div>
                  </TableCell>
                </TableRow>
